  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-9 h-9 flex items-center justify-center rounded-lg bg-blue-100 text-blue-500 hover:bg-blue-200 transition-colors"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-9 h-9 flex items-center justify-center rounded-lg bg-blue-100 text-blue-700 hover:bg-blue-200 transition-colors"
